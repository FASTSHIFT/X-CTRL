...
#define WIDGET_TFT_OBJECT Adafruit_SSD1306
#define WIDGET_Default_BG BLACK
#define WIDGET_Default_WG WHITE
...
{
public:
    Bitmap(WIDGET_TFT_OBJECT &obj, const uint8_t* bitmap_p, uint16_t x, uint16_t y, uint16_t w, uint16_t h);
    uint16_t Color_BG;
