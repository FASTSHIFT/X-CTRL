...
static void ADCx_DMA_Config(void)
{
    ...
    ADC_RegularChannelConfig(ADC1, PIN_MAP[JSL_Y_Pin].ADC_Channel,      1, ADC_SampleTime_480Cycles);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[JSR_X_Pin].ADC_Channel,      2, ADC_SampleTime_480Cycles);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[BattSensor_Pin].ADC_Channel, 3, ADC_SampleTime_480Cycles);
