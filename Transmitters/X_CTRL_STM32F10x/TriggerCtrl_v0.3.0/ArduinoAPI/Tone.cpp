...
/**
  ...
  * @retval 无
  */
void toneBlock_Volume(uint8_t Pin, uint32_t freq, uint32_t Time_ms, uint32_t vol)
{
    uint32_t TimePoint = millis() + Time_ms;
    uint32_t dlyus = 500000 / freq;
...
/**
  ...
  * @retval 无
  */
void toneBlock_Volume_us(uint8_t Pin, uint32_t freq, uint32_t Time_us, uint32_t vol)
{
