...
#define ClearItemPos(pos)	screen.fillRect(ItemStartX,ItemStartY+pos*TextHeight,screen.width()-ItemStartX-10,TextHeight,screen.Black)
 ...
 *       &page -> 页面调度器地址
 */
static MenuManager menu(ItemNum::MAX, 15, &page);
