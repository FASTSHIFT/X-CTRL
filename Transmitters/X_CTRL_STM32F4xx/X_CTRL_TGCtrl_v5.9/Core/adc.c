...
void bsp_InitAdc(void)
{
    ...
    ADC_RegularChannelConfig(ADC1, PIN_MAP[PA0].ADC_Channel, 1, ADC_SampleTime_480Cycles); /*设置规则通道16 3个序列 采样时间 */
    ADC_RegularChannelConfig(ADC1, PIN_MAP[PA1].ADC_Channel, 2, ADC_SampleTime_480Cycles); /*设置规则通道3 2个序列 采样时间 */
    ADC_RegularChannelConfig(ADC1, PIN_MAP[PA4].ADC_Channel, 3, ADC_SampleTime_480Cycles);
	ADC_RegularChannelConfig(ADC1, PIN_MAP[PC0].ADC_Channel, 4, ADC_SampleTime_480Cycles);
	ADC_RegularChannelConfig(ADC1, PIN_MAP[PC1].ADC_Channel, 5, ADC_SampleTime_480Cycles);
	ADC_RegularChannelConfig(ADC1, PIN_MAP[PC2].ADC_Channel, 6, ADC_SampleTime_480Cycles);
	ADC_RegularChannelConfig(ADC1, PIN_MAP[PC3].ADC_Channel, 7, ADC_SampleTime_480Cycles);
