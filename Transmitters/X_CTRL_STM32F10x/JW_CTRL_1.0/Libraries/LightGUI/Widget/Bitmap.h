...
public:
    Bitmap(T *obj, uint16_t* bitmap_p, uint16_t x, uint16_t y, uint16_t w, uint16_t h);
    Bitmap(T *obj, uint8_t* bitmap_p, uint16_t x, uint16_t y, uint16_t w, uint16_t h);
...
/**
  ...
  * @retval 无
  */
template <class T> Bitmap<T>::Bitmap(T *obj, uint16_t* bitmap_p, uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
    screen = obj;
    rgbbitmap = bitmap_p;
    bitmap = 0;
...
/**
  ...
  * @retval 无
  */
template <class T> Bitmap<T>::Bitmap(T *obj, uint8_t* bitmap_p, uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
    screen = obj;
    rgbbitmap = 0;
    bitmap = bitmap_p;
