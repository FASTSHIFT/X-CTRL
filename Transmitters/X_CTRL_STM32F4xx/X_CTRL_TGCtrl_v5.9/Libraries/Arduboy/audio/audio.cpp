...
//    prescalar_bits = 0b011;
    ...
    switch (timer_num) {
    case 1:
        TimerSet_InterruptTimeUpdate(TIMER1_REMAP, 500000.0 / frequency2);
        power_timer1_enable();
...
//      bitWrite(TIMSK1, OCIE1A, 1);
        break;
    case 3:
        TimerSet_InterruptTimeUpdate(TIMER3_REMAP, 500000.0 / frequency2);
        power_timer3_enable();
...
//  TCCR1B = (TCCR1B & 0b11111000) | prescalarbits;
    TimerSet_InterruptTimeUpdate(TIMER1_REMAP, 500000.0 / frequency);
