...
#define LV_IMG_CACHE_DEF_SIZE       128
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "delay.h"       /*Header for the sys time function*/
 ...
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(HandGotn_14)

/*Always set a default font from the built-in fonts*/
#define LV_FONT_DEFAULT        &HandGotn_14
...
#  define LV_TABVIEW_DEF_ANIM_TIME    500
#endif
