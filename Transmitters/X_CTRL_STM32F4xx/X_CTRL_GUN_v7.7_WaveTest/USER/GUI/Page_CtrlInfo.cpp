...
LightGUI::ProgressBar<SCREEN_CLASS> BarLimit_R(&screen, PBX_START, PBY_START + (PBx_Height + PBx_INTERVAL) * 2, PBx_Width, PBx_Height, 0);
LightGUI::ProgressBar<SCREEN_CLASS> BarLimit_L(&screen, PBX_START, PBY_START + (PBx_Height + PBx_INTERVAL) * 3, PBx_Width, PBx_Height, 0);
