...
//    ADC_RegularChannelConfig(ADC1, PIN_MAP[PA7].ADC_Channel, 8, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[PB0].ADC_Channel, 6, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[PB1].ADC_Channel, 7, ADC_SampleTime_55Cycles5);
