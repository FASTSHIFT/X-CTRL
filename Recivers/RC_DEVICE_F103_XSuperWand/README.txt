...
//Upgrade        8.14  V_4.9 整理USART相关代码，修改Tone库只占用一个定时器(可使用toneSetTimer()函数切换),time_exti改名为timer
//Upgrade        8.17  V_5.0 在Arduino.h添加了更完整的与GPIO寄存器交互函数，提升与第三方库的兼容性
//Upgrade        8.17  V_5.1 添加WCharacter.h，支持Arduino有关Characters的函数，添加mcu_type.h，使Arduino.h可以跨MCU使用
//Upgrade        9.3   V_5.2 更新Arduino.h、SPI库、Tone库、GPIO库、定时器库，更高的效率以及更好的兼容性
//Upgrade        9.6   V_5.3 修改了Core核心库的一些定义(更新之后可能会导致报错，请修改相关函数名)
//Upgrade        9.17  V_5.4 合并 HardwareSerial 与 usart 库，usart.h、usart.c已移除
//Upgrade        9.27  V_5.5 完善代码注释，提升SPI速度
//Upgrade        9.29  V_5.6 重新从stm32duino移植更高精度的pulseIn函数
//Upgrade       10.27  V_5.7 更新HardwareSerial，将USART发送完成标志位 USART_SR_TC 更换 USART_SR_TXE，更高的发送效率
//Upgrade       11.4   V_5.8 提升digitalWrite等函数运行效率
//Upgrade       11.20  V_5.9 修复TIM1与TIM8部分通道无法输出PWM的bug，更新SPI库
//Upgrade       11.29  V_6.0 更新detachInterrupt()函数
//Upgrade       12.10  V_6.1 补充Arduino.h和timer.c
