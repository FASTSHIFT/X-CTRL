...
public:
    ...
    void drawFastRGBBitmap(int16_t x, int16_t y, uint16_t *bitmap, int16_t w, int16_t h);
    void drawFastBitmap(int16_t x, int16_t y, uint8_t *bitmap, int16_t w, int16_t h);
