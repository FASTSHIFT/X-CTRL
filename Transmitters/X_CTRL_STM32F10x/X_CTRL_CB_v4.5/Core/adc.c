...
//    ADC_RegularChannelConfig(ADC1, PIN_MAP[PA6].ADC_Channel, 5, ADC_SampleTime_55Cycles5);
//    ADC_RegularChannelConfig(ADC1, PIN_MAP[PA7].ADC_Channel, 6, ADC_SampleTime_55Cycles5);
