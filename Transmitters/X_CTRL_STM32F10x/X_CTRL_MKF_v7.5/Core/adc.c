...
static void ADCx_DMA_Config(void)
{
    ...
    // 配置ADC 通道的转换顺序和采样时间
    ADC_RegularChannelConfig(ADC1, PIN_MAP[JSL_X_Pin].ADC_Channel,      1, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[JSL_Y_Pin].ADC_Channel,      2, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[JSR_X_Pin].ADC_Channel,      3, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[JSR_Y_Pin].ADC_Channel,      4, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC1, PIN_MAP[BattSensor_Pin].ADC_Channel, 5, ADC_SampleTime_55Cycles5);
