...
uint8_t BV_Buffer[BV_BUFF_HEIGHT * BV_BUFF_WIDTH * sizeof(uint16_t)];
...
bool Init_BvPlayer()
{
    ...
    BvPlayer.CallBackDrawPicture_u16 = Screen_FastDrawRGBBitmap;

    player1.CallBackDrawPicture_u8 = Screen_FastDrawBitmap;
    player2.CallBackDrawPicture_u8 = Screen_FastDrawBitmap;
    BvPlayer.CallBackDrawPicture_u8 = Screen_FastDrawBitmap;
