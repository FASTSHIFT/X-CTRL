...
#define K_LEFT              NULL_PIN
#define K_RIGHT             NULL_PIN
#define K_UP                NULL_PIN
#define K_DOWN              NULL_PIN
#define K_FIRE              KEY_CH_Pin

// GFX settings
//#define OPTIMIZE_SSD1306                // Optimizations for SSD1366 displays

#define FRAME_TIME          33.3//66.666666   // Desired time per frame in ms (66.666666 is ~15 fps)
