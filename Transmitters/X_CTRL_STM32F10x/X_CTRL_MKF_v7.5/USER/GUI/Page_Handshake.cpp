...
{
	uint16_t bgtime = 200;
	float pos1 = Animation_ProgressSlide(0, screen.width() + 1, ms, 2000, 2000);
	float pos2 = Animation_ProgressSlide(0, screen.width() + 1, ms + bgtime * 1, 2000, 2000);
	float pos3 = Animation_ProgressSlide(0, screen.width() + 1, ms + bgtime * 2, 2000, 2000);
	float pos4 = Animation_ProgressSlide(0, screen.width() + 1, ms + bgtime * 3, 2000, 2000);
	float pos5 = Animation_ProgressSlide(0, screen.width() + 1, ms + bgtime * 4, 2000, 2000);
	
	screen.fillRect(0,ProgressCursor_1.Y,1,4,screen.Black);
	
	if(pos1) ProgressCursor_1.setPosition(pos1, ProgressCursor_1.Y);
	if(pos2) ProgressCursor_2.setPosition(pos2, ProgressCursor_2.Y);
	if(pos3) ProgressCursor_3.setPosition(pos3, ProgressCursor_3.Y);
	if(pos4) ProgressCursor_4.setPosition(pos4, ProgressCursor_4.Y);
	if(pos5) ProgressCursor_5.setPosition(pos5, ProgressCursor_5.Y);
}
