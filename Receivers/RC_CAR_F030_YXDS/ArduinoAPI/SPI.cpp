...
void SPIClass::begin(void) 
{
	...
	if(SPIx == SPI1)
	{
		...
		GPIO_PinAFConfig(GPIOA, Get_GPIO_PinSource(GPIO_Pin_5), GPIO_AF_0);
		GPIO_PinAFConfig(GPIOA, Get_GPIO_PinSource(GPIO_Pin_6), GPIO_AF_0);
		GPIO_PinAFConfig(GPIOA, Get_GPIO_PinSource(GPIO_Pin_7), GPIO_AF_0);
