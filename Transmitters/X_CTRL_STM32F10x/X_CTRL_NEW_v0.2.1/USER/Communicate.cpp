...
void Task_LoadCtrlMode()
{
    ...
    else if(CTRL.Info.CtrlObject == CAR_DifferentalSteering)
    {
        ...
        LimitValue(CarDS.MotorSpeed.L, -1000, 1000);
        LimitValue(CarDS.MotorSpeed.R, -1000, 1000);
    }
    else if(CTRL.Info.CtrlObject == CAR_ServoSteering)
    {
        ...
        LimitValue(CarSS.MotorSpeed, -1000, 1000);
        LimitValue(CarSS.SteerAngle, -1000, 1000);
    }
}
