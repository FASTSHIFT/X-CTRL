...
void_func_point TIMx_Function[8] = {null_func, null_func, null_func, null_func, null_func, null_func, null_func, null_func};
...
void TimerSet_NVIC(TIM_TypeDef* TIMx, uint32_t InterruptTime_us, void_func_point f, u8 NVIC_IRQ_CPP, u8 NVIC_IRQ_CSP)
{
    ...
    TIMx_Function[TimerNum] = f;//Callback Functions
