    ...
    : Adafruit_GFX(S6B33B2_TFTWIDTH_128, S6B33B2_TFTHEIGHT_160)
{
    ...
    rdpinmask = digitalPinToBitMask(RD);
		...
		FontX = (char *)Fonts_MicrosoftYahei12px;
#endif
...
void TFT_S6B33B2::SetFontX(const char *font)
{
	FontX = (char *)font;
}
int TFT_S6B33B2::printfX(const char *fmt, ...) {
    ...
    SP_PrepareRect(FontX, (char *)TEXT_BUFFER, 0);
    SP_FillBuffer_SolidBrush(textbgcolor);
    SP_CoverString(FontX, (char *)TEXT_BUFFER, 0, textcolor);
