...
{
	uint16_t bgtime = 200;
	float pos1 = Animation_ProgressSlide(0, 128, ms, 2000, 2000);
	float pos2 = Animation_ProgressSlide(0, 128, ms + bgtime * 1, 2000, 2000);
	float pos3 = Animation_ProgressSlide(0, 128, ms + bgtime * 2, 2000, 2000);
	float pos4 = Animation_ProgressSlide(0, 128, ms + bgtime * 3, 2000, 2000);
	float pos5 = Animation_ProgressSlide(0, 128, ms + bgtime * 4, 2000, 2000);
