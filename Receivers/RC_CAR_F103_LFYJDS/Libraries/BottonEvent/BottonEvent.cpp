...
void BottonEvent_NULL_Function()//空函数
{
}
...
BottonEvent::BottonEvent(uint8_t Pin, bool NoPressState, uint16_t LongPressTimeMs_Set)
{
    ...
    BottonPress_Function = BottonEvent_NULL_Function;
    BottonLongPress_Function = BottonEvent_NULL_Function;
    BottonRelease_Function = BottonEvent_NULL_Function;
    BottonChange_Function = BottonEvent_NULL_Function;
}
