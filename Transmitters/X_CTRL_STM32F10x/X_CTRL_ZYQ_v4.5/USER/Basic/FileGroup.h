...
#define JSL_X_ADC() (ADC_MaxValue-analogRead_DMA(2))
#define JSL_Y_ADC() analogRead_DMA(3)
#define JSR_X_ADC() (ADC_MaxValue-analogRead_DMA(1))
#define JSR_Y_ADC() analogRead_DMA(0)
...
#define NRF_CE_Pin   D10
#define NRF_CSN_Pin  D9
//IRQ   MISO
//MOSI  SCK
//CSN   CE
//VCC   GND
